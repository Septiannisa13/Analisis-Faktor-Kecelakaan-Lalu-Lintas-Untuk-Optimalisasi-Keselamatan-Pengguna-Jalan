# -*- coding: utf-8 -*-
"""202110370311248_Data Mining_Road Traffic Accidents.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-eHZaRIoiqGl-W9MCysAs4Rmhkpi2ql_

LINK KAGGLE: https://www.kaggle.com/datasets/saurabhshahane/road-traffic-accidents
"""
...
for column in categorical_columns:
    print(f"\nDistribusi Kategori untuk Kolom '{column}':")
    ...
    plt.title(f'Distribusi Kategori untuk Kolom {column}')
    plt.xlabel(column)
    plt.ylabel('Jumlah')
...
axes[0].set_xticks(sorted(reverse_label_mapping.keys()))
axes[0].set_xticklabels([reverse_label_mapping[i] for i in sorted(reverse_label_mapping.keys())], rotation=45)
...
axes[1].set_xticks(sorted(reverse_label_mapping.keys()))
axes[1].set_xticklabels([reverse_label_mapping[i] for i in sorted(reverse_label_mapping.keys())], rotation=45)
